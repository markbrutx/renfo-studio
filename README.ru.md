<img src="docs/img/logo.png" alt="Renfo.studio" width="96">
...
на выходе — файлы 1792×2400 под печать 15×20 см при 300 dpi и PSD со
слоями для ретуши. Лицо берётся с исходного кадра и не редактируется.

<img src="docs/img/hero-spider.jpg" alt="Пример генерации — паучий герой" width="360">

> Ребёнок на изображении сгенерирован ИИ; такого человека не существует.
